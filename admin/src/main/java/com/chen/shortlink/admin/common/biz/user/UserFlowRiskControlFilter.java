...
import static com.chen.shortlink.admin.common.convention.errorcode.BaseErrorCode.FLOW_LIMIT_ERROR;
...
public class UserFlowRiskControlFilter implements Filter {
    ...
    private final static String USER_FLOW_RISK_CONTROL_LUA_SCRIPT_PATH="lua/user_flow_risk_control.lua";
    @SneakyThrows
    @Override
