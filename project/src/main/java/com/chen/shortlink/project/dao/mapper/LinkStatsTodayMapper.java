...
import com.chen.shortlink.project.dao.entity.LinkStatsTodayDTO;
 ...
 */
@Mapper
public interface LinkStatsTodayMapper extends BaseMapper<LinkStatsTodayDTO> {
    ...
    void shortTodayLinkStat(@Param("linkStatsToday") LinkStatsTodayDTO linkStatsToday);
}
